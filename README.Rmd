...
An R package for applying custom image filters using the `magick` package.
...
# then install the package (adjust the path)

devtools::install("path/to/ImageFilters")
```
